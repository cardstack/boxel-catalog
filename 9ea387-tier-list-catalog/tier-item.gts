...
export class TierItem extends CardDef {
  ...
  static isolated = class extends Component<typeof TierItem> {
  ...
  static embedded = class extends Component<typeof TierItem> {
    @tracked imgBroken = false;
    markBroken = () => {
      this.imgBroken = true;
    };
  ...
  static fitted = class extends Component<typeof TierItem> {
    @tracked imgBroken = false;
    markBroken = () => {
      this.imgBroken = true;
    };
  ...
  static atom = class extends Component<typeof TierItem> {
    <template>
