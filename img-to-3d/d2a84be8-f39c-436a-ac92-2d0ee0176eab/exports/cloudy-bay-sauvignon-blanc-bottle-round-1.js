...
function buildSculpture(THREE) {
  ...
  addPart({ id: 'cap-band', parent: 'root', primitive: 'curvedDecal', d: [0.1241, 0.08, 100], pos: [0, 1.9, 0], color: '#c9a227', texture: 'https://localhost:4201/catalog/img-to-3d/d2a84be8-f39c-436a-ac92-2d0ee0176eab/textures/screw-cap.webp', attachTo: 'screw-cap' }); // gold CLOUDY BAY neck band text
  addPart({ id: 'body-label', parent: 'root', primitive: 'curvedDecal', d: [0.2733, 0.83, 100], pos: [0, 0.5688, 0], color: '#f3f3f0', texture: 'https://localhost:4201/catalog/img-to-3d/d2a84be8-f39c-436a-ac92-2d0ee0176eab/textures/body-label.webp', attachTo: 'bottle-body' }); // white label with mountain graphic and wordmark
