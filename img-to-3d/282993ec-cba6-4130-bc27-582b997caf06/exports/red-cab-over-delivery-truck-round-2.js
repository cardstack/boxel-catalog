...
// generated by Boxel Img-to-3D Studio from its sculpt spec · round 2
//
...
function buildSculpture(THREE) {
  ...
  MATERIALS['m-grille'] = new THREE.MeshPhysicalMaterial({ color: new THREE.Color('#1a1b1e'), roughness: 0.9, metalness: 0.1, clearcoat: 0.15, clearcoatRoughness: 0.35, envMapIntensity: 0.35 });
  (function () {
  ...
  MATERIALS['m-glass'] = new THREE.MeshPhysicalMaterial({ color: new THREE.Color('#dfeef5'), roughness: 0.05, metalness: 0.1, transparent: true, opacity: 0.85, transmission: 0.9, ior: 1.5, thickness: 0.05, envMapIntensity: 1 });
  ...
  MATERIALS['m-bezel'] = new THREE.MeshPhysicalMaterial({ color: new THREE.Color('#1a1b1e'), roughness: 0.9, metalness: 0.1, clearcoat: 0.15, clearcoatRoughness: 0.35, envMapIntensity: 0.35 });
  MATERIALS['m-brake-light'] = new THREE.MeshPhysicalMaterial({ color: new THREE.Color('#e60000'), roughness: 0.2, metalness: 0.1, emissive: new THREE.Color('#990000'), emissiveIntensity: 0.3, clearcoat: 0.15, clearcoatRoughness: 0.35, envMapIntensity: 0.35 });
  ...
  addPart({ id: 'chassis-frame', parent: 'root', primitive: 'box', d: [0.9, 0.3, 3], pos: [0, 0.5, 0.2], mat: 'm-dark-steel', attachTo: 'tank-left' }); // structural beam under cab and box
  addPart({ id: 'main-cab', parent: 'root', primitive: 'roundedBox', d: [1, 1.3, 1.3, 0.08, 0.03], pos: [0, 0.93, -1.1], mat: 'm-red-gloss', attachTo: 'chassis-frame' }); // hollow driver cab shell
  addPart({ id: 'roof-fairing', parent: 'root', primitive: 'prism', d: [0.95, 0.9, 0.35], pos: [0, 1.88, -0.75], mat: 'm-red-gloss', attachTo: 'main-cab' }); // aero fairing tapering to cargo box
  addPart({ id: 'cargo-box', parent: 'root', primitive: 'box', d: [1.05, 1.5, 1.9], pos: [0, 1.45, 0.47], mat: 'm-red-satin', attachTo: 'chassis-frame' }); // enclosed rear cargo body
  addPart({ id: 'front-bumper', parent: 'root', primitive: 'roundedBox', d: [1, 0.5, 0.35, 0.05, 0.02], pos: [0, 0.61, -1.88], mat: 'm-red-gloss', attachTo: 'main-cab' }); // lower front housing headlights
  addPart({ id: 'headlight-left', parent: 'root', primitive: 'box', d: [0.18, 0.12, 0.05], pos: [-0.32, 0.66, -2.05], mat: 'm-headlight', attachTo: 'front-bumper' }); // multi-lens headlight cluster
  addPart({ id: 'headlight-right', parent: 'root', primitive: 'box', d: [0.18, 0.12, 0.05], pos: [0.32, 0.66, -2.05], mat: 'm-headlight', attachTo: 'front-bumper' }); // multi-lens headlight cluster
  addPart({ id: 'front-grille', parent: 'root', primitive: 'box', d: [0.5, 0.35, 0.08], pos: [0, 0.82, -1.68], mat: 'm-grille', attachTo: 'main-cab' }); // tiered louvered grille slats
  addPart({ id: 'side-window-left', parent: 'root', primitive: 'box', d: [0.05, 0.4, 0.5], pos: [-0.445, 1.22, -1], mat: 'm-glass', attachTo: 'main-cab' }); // driver side window
  addPart({ id: 'side-window-right', parent: 'root', primitive: 'box', d: [0.05, 0.4, 0.5], pos: [0.445, 1.22, -1], mat: 'm-glass', attachTo: 'main-cab' }); // passenger side window
  addPart({ id: 'side-mirror', parent: 'root', primitive: 'roundedBox', d: [0.12, 0.35, 0.15, 0.02, 0.01], pos: [-0.54, 1.35, -1.55], mat: 'm-mirror', attachTo: 'main-cab' }); // tall driver side mirror housing
  addPart({ id: 'front-wheel-left', parent: 'root', primitive: 'cylinder', d: [0.42, 0.42, 0.3, 20], pos: [-0.47, 0.42, -1], rot: [0, 0, 1.5708], mat: 'm-rubber', attachTo: 'chassis-frame' }); // front steer tire
  addPart({ id: 'front-wheel-right', parent: 'root', primitive: 'cylinder', d: [0.42, 0.42, 0.3, 20], pos: [0.47, 0.42, -1], rot: [0, 0, 1.5708], mat: 'm-rubber', attachTo: 'chassis-frame' }); // front steer tire
  addPart({ id: 'front-wheel-rim-left', parent: 'root', primitive: 'cylinder', d: [0.22, 0.22, 0.05, 16], pos: [-0.565, 0.42, -1], rot: [0, 0, 1.5708], mat: 'm-silver-metal', attachTo: 'front-wheel-left' }); // silver hub recessed in tire
  addPart({ id: 'front-wheel-rim-right', parent: 'root', primitive: 'cylinder', d: [0.22, 0.22, 0.05, 16], pos: [0.565, 0.42, -1], rot: [0, 0, 1.5708], mat: 'm-silver-metal', attachTo: 'front-wheel-right' }); // silver hub recessed in tire
  addPart({ id: 'rear-wheel-left', parent: 'root', primitive: 'cylinder', d: [0.42, 0.42, 0.3, 20], pos: [-0.2, 0.42, 1.3], rot: [0, 0, 1.5708], mat: 'm-rubber', attachTo: 'chassis-frame', repeat: { count: 2, mode: 'linear', offset: [-0.27, 0, 0] } }); // dual rear tire pair
  addPart({ id: 'rear-wheel-right', parent: 'root', primitive: 'cylinder', d: [0.42, 0.42, 0.3, 20], pos: [0.2, 0.42, 1.3], rot: [0, 0, 1.5708], mat: 'm-rubber', attachTo: 'chassis-frame', repeat: { count: 2, mode: 'linear', offset: [0.27, 0, 0] } }); // dual rear tire pair
  addPart({ id: 'tank-left', parent: 'root', primitive: 'cylinder', d: [0.18, 0.18, 0.9, 16], pos: [-0.42, 0.6233, 0.15], rot: [1.5708, 0, 0], mat: 'm-silver-metal', attachTo: 'chassis-frame' }); // aluminum fuel tank
  addPart({ id: 'tank-right', parent: 'root', primitive: 'cylinder', d: [0.18, 0.18, 0.9, 16], pos: [0.42, 0.6233, 0.15], rot: [1.5708, 0, 0], mat: 'm-silver-metal', attachTo: 'chassis-frame' }); // aluminum fuel tank
  addPart({ id: 'guard-left', parent: 'root', primitive: 'box', d: [0.06, 0.15, 1.6], pos: [-0.48, 0.55, 0.15], mat: 'm-guard-white', attachTo: 'chassis-frame' }); // underrun safety guard rail
  addPart({ id: 'guard-right', parent: 'root', primitive: 'box', d: [0.06, 0.15, 1.6], pos: [0.48, 0.55, 0.15], mat: 'm-guard-white', attachTo: 'chassis-frame' }); // underrun safety guard rail
  addPart({ id: 'side-mirror-right', parent: 'root', primitive: 'roundedBox', d: [0.12, 0.35, 0.15, 0.02, 0.01], pos: [0.54, 1.35, -1.55], mat: 'm-mirror', attachTo: 'main-cab' }); // tall passenger side mirror housing, mirrored counterpart
  addPart({ id: 'windshield-block', parent: 'root', primitive: 'box', d: [0.98, 0.9, 0.1], pos: [0, 1.25, -1.72], rot: [0.26, 0, 0], mat: 'm-glass', attachTo: 'main-cab' }); // large rectangular black glass windshield block
  addPart({ id: 'rear-wheel-rim-left', parent: 'root', primitive: 'cylinder', d: [0.22, 0.22, 0.05, 16], pos: [-0.565, 0.42, 1.3], rot: [0, 0, 1.5708], mat: 'm-silver-metal', attachTo: 'rear-wheel-left' }); // silver hub recessed in tire
  addPart({ id: 'rear-wheel-rim-right', parent: 'root', primitive: 'cylinder', d: [0.22, 0.22, 0.05, 16], pos: [0.565, 0.42, 1.3], rot: [0, 0, 1.5708], mat: 'm-silver-metal', attachTo: 'rear-wheel-right' }); // silver hub recessed in tire
  addPart({ id: 'rear-bumper', parent: 'root', primitive: 'box', d: [1, 0.12, 0.08], pos: [0, 0.45, 1.7], mat: 'm-dark-steel', attachTo: 'chassis-frame' }); // rear bumper bar mounted to chassis
  addPart({ id: 'brake-light-left', parent: 'root', primitive: 'box', d: [0.15, 0.06, 0.02], pos: [-0.3, 0.45, 1.75], mat: 'm-brake-light', attachTo: 'rear-bumper' }); // left red brake light lens
  addPart({ id: 'brake-light-right', parent: 'root', primitive: 'box', d: [0.15, 0.06, 0.02], pos: [0.3, 0.45, 1.75], mat: 'm-brake-light', attachTo: 'rear-bumper' }); // right red brake light lens
  addPart({ id: 'mudguard-left', parent: 'root', primitive: 'roundedBox', d: [0.55, 0.2, 0.9, 0.1, 3], pos: [-0.75, 0.85, 1.3], mat: 'm-dark-steel', attachTo: 'chassis-frame' }); // protective curved mudguard arch above left rear wheels
  addPart({ id: 'mudguard-right', parent: 'root', primitive: 'roundedBox', d: [0.55, 0.2, 0.9, 0.1, 3], pos: [0.75, 0.85, 1.3], mat: 'm-dark-steel', attachTo: 'chassis-frame' }); // protective curved mudguard arch above right rear wheels
