...
export class MultipleChoice extends CardDef {
  ...
  @field selectedOption = contains(StringField);
  @field turnNumber = contains(NumberField);
  @field timestamp = contains(DateTimeField);

  static embedded = class Embedded extends Component<typeof MultipleChoice> {
    ...
    <template>
      ...
      <style scoped>
        ...
        .confetti-bg {
          ...
          background-position: 0 0, 40px 40px, 20px 20px, 50px 10px;
          opacity: 0.2;
          pointer-events: none;
        }
        ...
        .title-text {
          ...
          font-weight: 800;
          color: #ffffff;
          text-shadow: 0 0 6px rgba(255,215,0,0.7), 0 0 10px rgba(255,215,0,0.5), 1px 1px 0 rgba(0,0,0,0.3);
        ...
        .gameshow-button.option-0 { background: linear-gradient(145deg, #ef4444, #dc2626); }
        .gameshow-button.option-1 { background: linear-gradient(145deg, #3b82f6, #2563eb); }
        .gameshow-button.option-2 { background: linear-gradient(145deg, #10b981, #059669); }
        .gameshow-button.option-3 { background: linear-gradient(145deg, #f59e0b, #d97706); }
        .gameshow-button.option-4 { background: linear-gradient(145deg, #8b5cf6, #7c3aed); }
        .gameshow-button.option-5 { background: linear-gradient(145deg, #ec4899, #db2777); }
        ...
        .gameshow-button:hover .button-shine { left: 100%; }
        ...
        .gameshow-button:hover {
          ...
          box-shadow: 0 6px 16px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.5), 0 0 15px rgba(255,255,255,0.3);
        }
        ...
        .gameshow-button:active { transform: translateY(-2px) scale(0.98); }
        ...
        @keyframes fill { 100% { box-shadow: inset 0 0 0 2rem #10b981; } }
        ...
        @media (max-width: 768px) {
          .gameshow-container { padding: 0.625rem; }
          .title-text { font-size: 0.8125rem; }
          .button-content { padding: 0.4375rem 0.5625rem; }
          .option-letter { width: 1.125rem; height: 1.125rem; font-size: 0.5625rem; }
