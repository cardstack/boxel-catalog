...
class AnnotationIsolated extends Component<typeof AnnotationCard> {
  ...
  get annotationTools() {
    return [{ id: 'drawing', name: 'Draw', icon: 'pen' }];
  }
        ...
        {{#if this.showNotes}}
          <div class='notes-panel'>
            <div class='notes-header'>
              <h3>Drawings (Page {{this.currentPage}})</h3>
            </div>
            ...
            {{else}}
              <div class='empty-notes'>
                ...
                <p class='empty-message'>No drawings on page
                  {{this.currentPage}}
                  yet.</p>
                <div class='annotation-tips'>
                  ...
                  <ul>
                    <li><strong>Drawing:</strong>
                      Click and drag on the document to create freehand drawings</li>
                    <li><strong>Thickness:</strong>
                      Adjust pen thickness using the toolbar controls</li>
                    <li><strong>Color:</strong>
                      Select your preferred drawing color (yellow is default)</li>
                  </ul>
                </div>
              </div>
            {{/if}}
