...
class AddendumEdit extends Component<typeof Addendum> {
...
// Contrast with Amendment (changes existing terms) and a waiver (excuses one
...
export class Addendum extends CardDef {
  ...
  // section shape and class names with Amendment so the modification
  // documents edit as siblings.
  static edit = AddendumEdit;
}
