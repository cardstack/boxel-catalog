 ...
 *
 * DIVISION OF LABOUR with the Support Ops kit's `escalate-case-command`:
 * this command moves a TICKET's queue/priority inside the agent kit; that one
 * owns the LADDER — the Escalation record, acknowledgement clocks and level
 * ranks, for any record type. Neither replaces the other; do not build a
 * third.
 *
