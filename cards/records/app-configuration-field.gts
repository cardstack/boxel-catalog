...
import { SlaWindowField } from './sla-window-field';
import { IntegrationReferenceField } from './external-reference-field';
import { AutomationPolicyField } from './automation-policy-field';
import { isValidIdentifierPattern } from './record-identifier-field';

/**
 * The bag of desk-level settings an l06 app card carries once:
