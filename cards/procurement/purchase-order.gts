...
class PurchaseOrderEdit extends Component<typeof PurchaseOrder> {
    ...
    <div class='po-edit'>
      ...
      <div class='edit-body'>
        ...
        <div class='sects'>
          ...
          >
            <h3>Order Identity
              <span class='sect-hint'>the PO number is stamped once at issue and
                never recomputed</span></h3>
          ...
          >
            <h3>Line Items
              <span class='sect-hint'>the committed total is computed from these
                lines</span></h3>
            <FieldContainer
          ...
          >
            ...
            <div class='row two'>
              ...
              <FieldContainer
                @label='Budget to commit against'
                @vertical={{true}}
              >
                <@fields.budget />
              </FieldContainer>
...
class PurchaseOrderIsolated extends Component<typeof PurchaseOrder> {
  @tracked busy = false;
...
export class PurchaseOrder extends CardDef {
  ...
  static isolated = PurchaseOrderIsolated;
  ...
  // gets the EditSectionNav rail. totalAmount and title
  // are computed (computeVia) and deliberately excluded.
  static edit = PurchaseOrderEdit;
}
