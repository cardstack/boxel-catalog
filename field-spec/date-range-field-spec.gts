...
class DateRangeFieldSpecIsolated extends Component<typeof DateRangeFieldSpec> {
  <template>
...
class DateRangeFieldSpecEdit extends Component<typeof DateRangeFieldSpec> {
  <template>
    <article class='container'>
...
export class DateRangeFieldSpec extends Spec {
  ...
  // Standard DateRangeField
  @field standard = contains(DateRangeField);

  static isolated =
    DateRangeFieldSpecIsolated as unknown as typeof Spec.isolated;
  static edit = DateRangeFieldSpecEdit as unknown as typeof Spec.edit;
}
