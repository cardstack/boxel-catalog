...
import MonthDayField from 'https://cardstack.com/base/date/month-day';
import CodeSnippet from '../components/code-snippet';

const standardFieldCode = `@field standard = contains(MonthDayField);`;

class MonthDayFieldSpecIsolated extends Component<typeof MonthDayFieldSpec> {
  <template>
...
class MonthDayFieldSpecEdit extends Component<typeof MonthDayFieldSpec> {
  <template>
    <article class='container'>
...
export class MonthDayFieldSpec extends Spec {
  ...
  // Standard MonthDayField configuration
  @field standard = contains(MonthDayField);

  static isolated =
    MonthDayFieldSpecIsolated as unknown as typeof Spec.isolated;
  static edit = MonthDayFieldSpecEdit as unknown as typeof Spec.edit;
}
