...
const usageCode = `@field contactLink = contains(ContactLinkField);`;

export class ContactLinkExample extends CardDef {
  static displayName = 'Contact Link Example';
    ...
    apiRows = [
      {
        ...
        type: 'string',
        default: '—',
        desc: 'Display label for the contact.',
      },
      {
        name: 'value',
        type: 'string',
        default: '—',
        desc: 'Raw contact value: handle, number, or address.',
      },
      {
        name: 'url',
        type: 'string',
        default: 'computed',
        desc: 'Link derived from label and value.',
      },
    ];
      ...
      <article class='field-example'>
        ...
        <section class='fe-panel'>
          ...
          <div class='fe-panel-body'>
            <@fields.contactLink @format='edit' />
          </div>
        </section>
