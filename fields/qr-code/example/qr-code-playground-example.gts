...
import QRField from '../qr-code';

const usageCode = `@field qrCode = contains(QRField);`;

export class QRCodeExample extends CardDef {
  static displayName = 'QR Code Example';
    ...
    apiRows = [
      {
        ...
        type: 'string',
        default: '—',
        desc: 'Text or URL encoded in the QR code.',
      },
      {
        name: 'config.foreground',
        type: 'color',
        default: '#000000',
        desc: 'Module (foreground) color.',
      },
      {
      ...
      },
      {
        ...
        type: 'number',
        default: '4',
        desc: 'Quiet-zone margin in modules.',
      },
    ];
