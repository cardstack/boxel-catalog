...
import AudioField, { type AudioFieldConfiguration } from '../audio';

const demoConfig: AudioFieldConfiguration = { presentation: 'mini-player' };

const usageCode = `@field audio = contains(AudioField, { searchable: 'file' });`;
const configCode = `const demoConfig: AudioFieldConfiguration = { presentation: 'mini-player' };

@field configuredAudio = contains(AudioField, {
  configuration: demoConfig,
  searchable: 'file',
});`;

export class AudioExample extends CardDef {
  static displayName = 'Audio Example';

  @field audio = contains(AudioField, { searchable: 'file' });
  @field configuredAudio = contains(AudioField, {
    configuration: demoConfig,
    searchable: 'file',
  });
  ...
  static isolated = class Isolated extends Component<typeof this> {
    apiRows = [
      {
        name: 'presentation',
        type: 'default | waveform-player | mini-player | album-cover | trim-editor | playlist-row',
        default: 'default',
        desc: 'Player layout style.',
      },
      {
        name: 'options',
        type: 'AudioFieldOptions',
        default: '—',
        desc: 'Presentation-specific display options.',
      },
    ];
    ...
    <template>
      <article class='field-example'>
        ...
        <section class='fe-panel'>
          ...
          <div class='fe-panel-body'>
            <@fields.configuredAudio @format='edit' />
          </div>
        ...
        <section class='fe-panel'>
          ...
          <p class='fe-api-intro'>Typed by AudioFieldConfiguration, exported by
            the field.</p>
          <div class='fe-api'>
