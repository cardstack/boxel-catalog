...
import QuantityField, { type QuantityFieldConfiguration } from '../quantity';

const demoConfig: QuantityFieldConfiguration = {
  presentation: 'quantity',
  options: { min: 0, max: 100 },
};

const usageCode = `@field quantity = contains(QuantityField);`;
const configCode = `const demoConfig: QuantityFieldConfiguration = {
  presentation: 'quantity',
  options: { min: 0, max: 100 },
};

@field configuredQuantity = contains(QuantityField, {
  configuration: demoConfig,
});`;

export class QuantityExample extends CardDef {
  static displayName = 'Quantity Example';

  @field quantity = contains(QuantityField);
  @field configuredQuantity = contains(QuantityField, {
    configuration: demoConfig,
  });
    ...
    <template>
      <article class='field-example'>
        ...
        <section class='fe-panel'>
          ...
          <div class='fe-panel-body'>
            <@fields.configuredQuantity @format='edit' />
          </div>
        ...
        <section class='fe-panel'>
          ...
          <p class='fe-api-intro'>Typed by QuantityFieldConfiguration, exported
            by the field.</p>
          <div class='fe-api'>
