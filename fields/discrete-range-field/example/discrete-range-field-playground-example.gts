...
const usageCode = `@field range = contains(DiscreteRangeField);`;

export class DiscreteRangeExample extends CardDef {
  static displayName = 'Discrete Range Example';

  @field range = contains(DiscreteRangeField);
    ...
    apiRows = [
      {
        ...
        type: 'number',
        default: '—',
        desc: 'Selected range start.',
      },
      {
        name: 'endValue',
        type: 'number',
        default: '—',
        desc: 'Selected range end.',
      },
      {
        name: 'min',
        type: 'number',
        default: '—',
        desc: 'Lowest selectable bound.',
      },
      {
        name: 'max',
        type: 'number',
        default: '—',
        desc: 'Highest selectable bound.',
      },
      {
        name: 'interval',
        type: 'number',
        default: '—',
        desc: 'Step between values.',
      },
    ];
