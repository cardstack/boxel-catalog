...
import GeoSearchPointField, {
  type GeoSearchPointConfiguration,
} from '../geo-search-point';

const demoConfig: GeoSearchPointConfiguration = {
  options: {
...
const usageCode = `@field location = contains(GeoSearchPointField);`;
const configCode = `const demoConfig: GeoSearchPointConfiguration = {
  options: {
    placeholder: 'Search a place...',
    showTopSearchResults: true,
    topSearchResultsLimit: 5,
...
@field configuredLocation = contains(GeoSearchPointField, {
  configuration: demoConfig,
});`;

export class GeoSearchPointExample extends CardDef {
  static displayName = 'Geo Search Point Example';
    ...
    apiRows = [
      {
        ...
        type: 'string',
        default: '—',
        desc: 'Search box placeholder text.',
      },
      {
        name: 'tileserverUrl',
        type: 'string',
        default: '—',
        desc: 'Map tile server URL.',
      },
      {
        name: 'mapHeight',
        type: 'string',
        default: '—',
        desc: 'Map height CSS value.',
      },
      {
        name: 'showTopSearchResults',
        type: 'boolean',
        default: 'false',
        desc: 'Show top result suggestions.',
      },
      {
        name: 'topSearchResultsLimit',
        type: 'number',
        default: '—',
      ...
      },
      {
        ...
        type: 'boolean',
        default: '—',
        desc: 'Show recent searches.',
      },
      {
        name: 'recentSearchesLimit',
        type: 'number',
        default: '—',
        desc: 'Max recent searches shown.',
      },
    ];
    ...
    <template>
      <article class='field-example'>
        ...
        <section class='fe-panel'>
          ...
          <p class='fe-api-intro'>Typed by GeoSearchPointConfiguration, exported
            by the field.</p>
          <div class='fe-api'>
