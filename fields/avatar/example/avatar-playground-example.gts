...
const usageCode = `@field avatar = contains(Avatar);`;

export class AvatarExample extends CardDef {
  static displayName = 'Avatar Example';
    ...
    apiRows = [
      {
        ...
        type: 'string',
        default: '—',
        desc: 'Hair or hat style.',
      },
      {
        name: 'accessoriesType',
        type: 'string',
        default: '—',
        desc: 'Glasses or accessories.',
      },
      { name: 'hairColor', type: 'string', default: '—', desc: 'Hair color.' },
      {
        name: 'facialHairType',
        type: 'string',
        default: '—',
        desc: 'Facial hair style.',
      },
      {
        name: 'clotheType',
        type: 'string',
      ...
      { name: 'eyeType', type: 'string', default: '—', desc: 'Eye style.' },
      {
        name: 'eyebrowType',
        type: 'string',
        default: '—',
      ...
      { name: 'mouthType', type: 'string', default: '—', desc: 'Mouth style.' },
      { name: 'skinColor', type: 'string', default: '—', desc: 'Skin color.' },
    ];
