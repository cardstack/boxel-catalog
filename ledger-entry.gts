...
export class LedgerEntry extends CardDef {
  ...
  @field cardTitle = contains(StringField, {
    computeVia: function (this: LedgerEntry) {
      return this.description ?? 'Untitled Entry';
    },
  });

  static embedded = class Embedded extends Component<typeof LedgerEntry> {
    get debitDisplay() {
