...
import type * as ColorFieldModule from '@cardstack/catalog-realm/fields/color';
import type * as DateFieldModule from '@cardstack/catalog-realm/fields/date';
import type * as DateRangeFieldModule from '@cardstack/catalog-realm/fields/date/date-range';
import type * as DayFieldModule from '@cardstack/catalog-realm/fields/date/day';
import type * as MonthFieldModule from '@cardstack/catalog-realm/fields/date/month';
import type * as MonthDayFieldModule from '@cardstack/catalog-realm/fields/date/month-day';
import type * as MonthYearFieldModule from '@cardstack/catalog-realm/fields/date/month-year';
import type * as QuarterFieldModule from '@cardstack/catalog-realm/fields/date/quarter';
import type * as WeekFieldModule from '@cardstack/catalog-realm/fields/date/week';
import type * as YearFieldModule from '@cardstack/catalog-realm/fields/date/year';
import type * as DatetimeFieldModule from '@cardstack/catalog-realm/fields/date-time';
import type * as DatetimeStampFieldModule from '@cardstack/catalog-realm/fields/datetime-stamp';
...
import type * as NumberFieldModule from '@cardstack/catalog-realm/fields/number';
import type * as RecurringPatternFieldModule from '@cardstack/catalog-realm/fields/recurring-pattern';
import type * as TimeFieldModule from '@cardstack/catalog-realm/fields/time';
import type * as DurationFieldModule from '@cardstack/catalog-realm/fields/time/duration';
import type * as RelativeTimeFieldModule from '@cardstack/catalog-realm/fields/time/relative-time';
import type * as TimeRangeFieldModule from '@cardstack/catalog-realm/fields/time/time-range';
