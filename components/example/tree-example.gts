...
import { Task } from '../../cards/tasks/task';
...
export class TreeExample extends CardDef {
  static displayName = 'Tree Example';
  static icon = ListTreeIcon;

  @field records = linksToMany(() => Task);

  static isolated = class Isolated extends Component<typeof TreeExample> {
