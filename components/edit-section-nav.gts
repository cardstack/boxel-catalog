...
// Each section is a numbered stop (01, 02…) on a vertical rail; the active stop's number inverts into a
...
// the reader is.
//
// Colour: this is a REUSABLE component, so it asserts no
// brand of its own — it exposes two knobs, --edit-section-nav-ink /
...
// background pair inverted (a guaranteed-contrast pairing) — never
